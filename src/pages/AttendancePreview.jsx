...
function AttendancePreview() {
  ...
  const rows = useMemo(() => buildAttendanceSummary({ attendanceLogs: logs, employees, month, attendanceAdjustments: adjustments, manualWorkdays: manuals }), [adjustments, employees, logs, manuals, month])
